...
void *exe_recv(void *tmp){
    ssize_t NMAX=8192;//sendでも宣言されている
    ...
    double f_list[5]={0.0, 100.0, 300.0, 1700.0, 18300.0};//変化させる周波数域
...
void exe_send(int s){
    ...
    while(1){
        ...
        if(flag_tmp=='a'){//その文字が意味を与えたている文字であればグローバル変数を書き換える
          flag='a';
        }else if(flag_tmp=='b')flag='b';
        else if(flag_tmp=='c')flag='c';
        else if(flag_tmp=='d')flag='d';
        else if(flag_tmp=='e')flag='e';
        else if(flag_tmp=='f')flag='f';
        else if(flag_tmp=='g')flag='g';
        else if(flag_tmp=='h')flag='h';
        else if(flag_tmp=='i')flag='i';
        else if(flag_tmp=='j')flag='j';
        else if(flag_tmp=='k')flag='k';
        else if(flag_tmp=='l')flag='l';
        else if(flag_tmp=='m')flag='m';
